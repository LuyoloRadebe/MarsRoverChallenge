...
module RoverModel
  ...
  class MissionState < Struct.new(:game_state, :upper_right_coord, :rover, :input)
  end

  def self.initial_mission_state   
    RoverModel::MissionState.new(RoverModel::GameState::S,RoverModel::GridCoord.new(5,5),[RoverModel::Rover.new(RoverModel::Position.new(1,2),Orientation::N,'LMLMLMLMM'),RoverModel::Rover.new(RoverModel::Position.new(3,3),Orientation::E,'MMRMMRMRRM')],[])     
    # how to reference 
    # @state.game_state
